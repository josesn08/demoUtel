...
export let mascotasPrueba: Mascota[] = [
  ...
  {id:6, nombre:'Theodore', propietario:'atellez', fechaNac:new Date('2021-11-25'), raza:'Ragdoll', color:'Blanco/Gris', genero:'Macho', tipo:2, fotoUrl:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJMoYr8zSHRLKARvYssUFwdOMDguDIKqXd5gCJ9Odg7Sk1ZgZPMOANB1UWmQgkHTjIXH8&usqp=CAU'},
